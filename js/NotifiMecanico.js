...
function loadNotifications() {
    ...
    // Filtrar las notificaciones con el mensaje "Se ha agregado una nueva cita"
    const filteredNotifications = notifications.filter(notification => notification.message === "Se ha agregado una nueva cita");
